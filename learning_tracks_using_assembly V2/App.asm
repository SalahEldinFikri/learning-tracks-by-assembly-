...
Data_roadmab DB " 1=> Data_roadmap ","$"
...
Back_roadmab DB " 1=> Back_roadmap ","$"
...
da db "                       ************"  ,10 ,"$"
wr db 10,10,">>>>> sorry ! Wrong Answer **** ","$"
try db 10,10,"*********************  Try again  *********************  ","$"
well db 10,10," ****************** Congratulation !!*************","$"
x db ?
scor_ db 10,">>>> your scor is : ","$"
scor__ db " / 9 ***","$"
.CODE
                            ...
                            FF3:
                             ...
                             FF9:
                              ...
                              scorr:
                                 ...
                                 lea Dx ,scor__   ; to dispay congratulation
                                 MOV AH,09h
                                 INT 21H
